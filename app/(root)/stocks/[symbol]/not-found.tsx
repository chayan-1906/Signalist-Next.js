        ...
        <div className={'min-h-screen flex items-center justify-center px-4 py-16'}>
            <div className={'flex flex-col items-center justify-center text-center max-w-2xl'}>
                ...
                <div className={'mb-8 relative'}>
                    ...
                    <TrendingUp className={'size-24 text-yellow-400 relative z-10'} strokeWidth={1.5}/>
                </div>

                {/* Error Code */}
                <div className={'mb-4'}>
                    <h1 className={'text-8xl font-bold text-gray-700 mb-2'}>404</h1>
                    <h2 className={'text-3xl font-bold text-gray-100'}>Stock Not Found</h2>
                </div>

                {/* Description */}
                <p className={'text-gray-400 text-lg mb-8 max-w-md'}>The stock symbol you're looking for doesn't exist or is not available.</p>
                ...
                <div className={'flex flex-col sm:flex-row gap-4 w-full sm:w-auto'}>
                    ...
                    <Button asChild variant={'outline'} className={'flex items-center justify-center gap-2 min-w-[160px] border-gray-600 text-gray-400 hover:bg-gray-800 hover:text-gray-100'}>
...
export default StockNotFoundPage;
