...
function StockErrorPage({error, reset}: StockErrorPageProps) {
    ...
    return (
        <div className={'min-h-screen flex items-center justify-center px-4 py-16'}>
            <div className={'flex flex-col items-center justify-center text-center max-w-2xl'}>
                ...
                {/* Error Description */}
                <p className={'text-gray-400 text-lg mb-2'}>We couldn't load this stock's data. This might be due to:</p>
